...
Computation times
=================
**02:06.372** total execution time for 9 files **from auto_examples**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_auto_examples_animating_data.py` (``animating_data.py``)
     - 00:29.838
     - 0.0
   ...
   * - :ref:`sphx_glr_auto_examples_querying_data.py` (``querying_data.py``)
     - 00:12.690
     - 0.0
   * - :ref:`sphx_glr_auto_examples_plotting_data.py` (``plotting_data.py``)
     - 00:09.720
     - 0.0
   * - :ref:`sphx_glr_auto_examples_create_rgb_map.py` (``create_rgb_map.py``)
     - 00:06.101
     - 0.0
