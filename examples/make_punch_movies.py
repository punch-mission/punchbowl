...
Original file is located at
    https://colab.research.google.com/drive/1xh3QUEbHhXyCwZ-bJjmdO-t11x6uSkQc

# Tutorial for creating PUNCH movies

This Google Colab creates movies off-screen. It downloads the data based on your input of a date range, and required data level and data product. The data products are documented at: https://punchbowl.readthedocs.io/en/latest/data/data_codes.html
"""
