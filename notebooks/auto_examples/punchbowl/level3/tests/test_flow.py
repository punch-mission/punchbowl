...
def test_PIM_flow_runs_with_filenames(sample_ndcube, tmpdir, prefect_test_fixture):
...
def test_PIM_flow_runs_with_objects_and_calibration_files(tmpdir, sample_ndcube, num_files, prefect_test_fixture):
