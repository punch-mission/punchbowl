...
def levelq_core_flow(data_list: list[str] | list[NDCube],
    ...
    if data_list:
        ...
        output_data_mosaic.meta["DATE"] = datetime.now(timezone.utc).isoformat()
        ...
        output_data_nfi.meta["DATE"] = datetime.now(timezone.utc).isoformat()
        ...
        output_dateobs = datetime.now(timezone.utc).isoformat()
