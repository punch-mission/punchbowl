...
def quickpunch_core_flow(data_list: Union[List[str], List[PUNCHData]]) -> List[PUNCHData]:
    logger = get_run_logger()

    logger.info("beginning quick punch core flow")
    ...
    logger.info("ending quick punch core flow")
    return data_list
